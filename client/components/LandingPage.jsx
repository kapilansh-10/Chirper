        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight">
              See what's happening <span className="text-indigo-600">right now</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button 
                onClick={() => setCurrentView('register')}
                className="bg-indigo-600 text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-indigo-700 transition shadow-lg text-center cursor-pointer"
              >
                Get Started
              </button>
              <button 
                onClick={() => setCurrentView('login')}
                className="bg-white text-indigo-600 border-2 border-indigo-600 px-8 py-3 rounded-full text-lg font-semibold hover:bg-indigo-50 transition text-center cursor-pointer"
              >
                Sign In
              </button>
            </div>
          ...
          <div className="hidden md:block relative">
            <div className="absolute -inset-4 bg-indigo-200 rounded-full blur-3xl opacity-30 animate-pulse"></div>
